...
namespace Human_Resources.Controllers
{
    public class ModuleReportController : Controller
    {
		...
		public ActionResult Filtrar2(String Name, String Departament)//Filtrado de Empleados Inactivos por Mes
		{
			//ViewBag.Departament = new SelectList(db.EmpleadosActivos(), "Departament1", "Name", "Lastname");
			var filt = from s in db.EmpleadosActivos() select s;
		...
		public ActionResult EmployeeActive()//Stored Procedures EmployeeActive
		{
			return View(db.EmpleadosActivos());
		}

		public ActionResult EmployeeInactive()//Stored Procedures EmployeeInactive
		{
			return View(db.EmpleadosInactivos());
		}

		public ActionResult DepartamentosCreados()//Proc Departamentos Creados
		{
			return View(db.DepartamentCreated());
		}

		public ActionResult CargosCreados()//Proc Cargos Creados
		{
			return View(db.PositiontCreated());
		}
